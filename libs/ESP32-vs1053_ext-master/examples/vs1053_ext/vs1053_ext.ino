...
WiFi.begin("hotspot2","abc123098a#");
    while (WiFi.status() != WL_CONNECTED) delay(1500);
    mp3.begin();
    
    mp3.setVolume(volume);
    Serial.println("Ver and ChipID");
        mp3.printVersion();
    mp3.printChipID();
//    mp3.connecttohost("radio2.teploe.net:8000/racja320");
...
//mp3.connecttohost("http://st01.dlf.de/dlf/01/128/mp3/stream.mp3");
//  mp3.connecttoFS(SPIFFS, "adhan.mp3");
